...
namespace Libplanet.Action
{
    ...
    internal class FeeCollector : IFeeCollector
    {
        ...
        public IWorld Mortgage(IWorld world)
        {
            ...
            IAccount account = world.GetAccount(_context.GasAccount);
            ...
            return world.SetAccount(_context.GasAccount, nextAccount);
        }
        ...
        public IWorld Refund(IWorld world)
        {
            ...
            IAccount nextAccount = world.GetAccount(_context.GasAccount).MintAsset(
                _context,
                _context.Signer,
