...
#pragma warning disable LAA1002
            ...
            public IValue GetState(Address address)
                => _states.GetValueOrDefault(address, default(Null));

            public bool TryGetState(Address address, out IValue value)
            {
                bool result = _states.TryGetValue(address, out IValue inValue);
                value = inValue;
                return result;
            }
